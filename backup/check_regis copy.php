<?php 
    ...
    if (isset($_POST["submit"])) {
        ...
        $stmt->bindParam(13, $province);
        $stmt->bindParam(14, $food);
        $stmt->bindParam(15, $food_allergy);
        $stmt->bindParam(16, $workshop_day1);
        $stmt->bindParam(17, $workshop_day2);
        $stmt->bindParam(18, $regis_group);
        $stmt->bindParam(19, $regis_payment_rate);
