                  ...
                  <div class="m-2">
                    <div class="form-row ">
                      <div class="form-group col-md-4">
                        ...
                        <input class="form-control" list="title" name="title[]" placeholder="โปรดระบุ">
                        <datalist id="title">
                          <option value="นาย (Mr.)">
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="fname" name="fname[]" placeholder="ชื่อ(Name)"
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="nationality" name="nationality[]" placeholder="สัญชาติ (Nationality)">
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                      <div class="form-group col-12">
                        <label for="adds">รายละเอียดในการออกใบเสร็จ (Billing Information)</label>
                        <div class="pl-3">
                          <div class="custom-control custom-radio">
                            <input type="radio" id="Billing1" name="Billing_info[]" class="custom-control-input" value="1"
                              checked>
                            <label class="custom-control-label"
                              for="Billing1">ใช้ชื่อและที่อยู่ของต้นสังกัด(Affiliation's name and address)</label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" id="Billing2" name="Billing_info[]" class="custom-control-input"
                              value="2">
                            <label class="custom-control-label" for="Billing2">อื่นๆ โปรดระบุ (Others, Pkeade
                              specify)</label>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="form-group col-6 mt-2">
                        ...
                        <div class="pl-3">
                          <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label" for="food1">ทั่วไป (Not Specific)</label>
                          </div>
                          <div class="custom-control custom-radio">
                    ...
                    <div class="form-row  mt-2">
                      <div class="form-group col-12 gray mt-2">
                        ...
                        <div class="form-group ml-3">
                          ...
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_2_1 "
                              name="workshop_day1_2" value="w1">
                            <label class="custom-control-label" for="workshop_day1_2_1">Workshop 1 : Design
                              Thinking <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[0]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_2_2"
                              name="workshop_day1_2" value="w2">
                            <label class="custom-control-label" for="workshop_day1_2_2">Workshop 2 : Research to
                              Innovation <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[1]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_2_3"
                              name="workshop_day1_2" value="w3">
                            <label class="custom-control-label" for="workshop_day1_2_3">Workshop 3 : Contemplative
                              education: Learn Unlearn and Relearn <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[2]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_2_4"
                              name="workshop_day1_2" value="w4">
                            <label class="custom-control-label" for="workshop_day1_2_4">Workshop 4 : Development and
                              Implementation-Game design-Board game <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[3]; ?> ที่</span></label>
                          </div>
                        </div>
                        <!-- Day 2 -->
                        <div class="form-group ml-3">
                          ...
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_2_1 "
                              name="workshop_day2_2" value="w5">
                            <label class="custom-control-label" for="workshop_day2_2_1">Workshop 5 : เนรมิตห้องเรียน 4.0
                              ด้วยเครื่องมือดิจิทัล <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance_2[0]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_2_2"
                              name="workshop_day2_2" value="w6">
                            <label class="custom-control-label" for="workshop_day2_2_2">Workshop 6 : Micro mastery:
                              ประสบการณ์การพัฒนาการเรียนรู้เพื่อสร้าง “ความเก่งทีละเล็กทีละน้อย <span
                                class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[1]; ?>
                                ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_2_3"
                              name="workshop_day2_2" value="w7">
                            <label class="custom-control-label" for="workshop_day2_2_3">Workshop 7 :
                              วิจัยจัดการเรียนการสอน <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance_2[2]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_2_4"
                              name="workshop_day2_2" value="w8">
                            <label class="custom-control-label" for="workshop_day2_2_4">Workshop 8 :
                              สร้างห้องเรียนแห่งอนาคตด้วยเทคโนโลยี iPad และ Personalization of Learning <span
                                class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[3]; ?>
                                ที่</span></label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-row  mt-2">
                      <div class="form-group col-12 gray mt-2">
                        ...
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 30 เมษายน พ.ศ. 2563 (13.00 - 14.30 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_3_1 "
                              name="workshop_day1_3" value="w1">
                            <label class="custom-control-label" for="workshop_day1_3_1">Workshop 1 : Design
                              Thinking <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[0]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_3_2"
                              name="workshop_day1_3" value="w2">
                            <label class="custom-control-label" for="workshop_day1_3_2">Workshop 2 : Research to
                              Innovation <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[1]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_3_3"
                              name="workshop_day1_3" value="w3">
                            <label class="custom-control-label" for="workshop_day1_3_3">Workshop 3 : Contemplative
                              education: Learn Unlearn and Relearn <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[2]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_3_4"
                              name="workshop_day1_3" value="w4">
                        ...
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 1 พฤษภาคม พ.ศ. 2563 (14.45 - 16.00 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_3_1 "
                              name="workshop_day2_3" value="w5">
                            <label class="custom-control-label" for="workshop_day2_3_1 ">Workshop 5 : เนรมิตห้องเรียน
                              4.0
                              ด้วยเครื่องมือดิจิทัล <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance_2[0]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_3_2 "
                              name="workshop_day2_3" value="w6">
                            <label class="custom-control-label" for="workshop_day2_3_2 ">Workshop 6 : Micro mastery:
                              ...
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[1]; ?>
                                ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_3_3 "
                              name="workshop_day2_3" value="w7">
                            <label class="custom-control-label" for="workshop_day2_3_3 ">Workshop 7 :
                              วิจัยจัดการเรียนการสอน
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[2]; ?>
                                ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_3_4 "
                              name="workshop_day2_3" value="w8">
                            <label class="custom-control-label" for="workshop_day2_3_4 ">Workshop 8 :
                              ...
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[3]; ?>
                                ที่</span></label>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="form-row  mt-2">
                      <div class="form-group col-12 gray mt-2">
                        ...
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 30 เมษายน พ.ศ. 2563 (13.00 - 14.30 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_4_1 "
                              name="workshop_day1_4" value="w1">
                            <label class="custom-control-label" for="workshop_day1_4_1">Workshop 1 : Design
                              Thinking <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[0]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_4_2 "
                              name="workshop_day1_4" value="w2">
                            <label class="custom-control-label" for="workshop_day1_4_2">Workshop 2 : Research to
                              Innovation <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[1]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_4_3"
                              name="workshop_day1_4" value="w3">
                            <label class="custom-control-label" for="workshop_day1_4_3">Workshop 3 : Contemplative
                              education: Learn Unlearn and Relearn <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance[2]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_4_4"
                              name="workshop_day1_4" value="w4">
                        ...
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 1 พฤษภาคม พ.ศ. 2563 (14.45 - 16.00 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_4_1"
                              name="workshop_day2_4" value="w5">
                            <label class="custom-control-label" for="workshop_day2_4_1">Workshop 5 : เนรมิตห้องเรียน 4.0
                              ด้วยเครื่องมือดิจิทัล <span class="badge badge-warning">เหลือที่นั่งอีก
                                <?php echo $workshop_balance_2[0]; ?> ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_4_2"
                              name="workshop_day2_4" value="w6">
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_4_3"
                              name="workshop_day2_4" value="w7">
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_4_4"
                              name="workshop_day2_4" value="w8">
                    ...
                    <div class="form-row  mt-2">
                      <div class="form-group col-12 gray mt-2">
                        ...
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 30 เมษายน พ.ศ. 2563 (13.00 - 14.30 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_5_1 "
                              name="workshop_day1_5" value="w1">
                            <label class="custom-control-label" for="workshop_day1_5_1 ">Workshop 1 : Design
                              Thinking
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance[0]; ?>
                                ที่</span></label>
                          </div>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_5_2"
                              name="workshop_day1_5" value="w2">
                            <label class="custom-control-label" for="workshop_day1_5_2">Workshop 2 : Research to
                              Innovation
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance[1]; ?>
                                ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_5_3"
                              name="workshop_day1_5" value="w3">
                            <label class="custom-control-label" for="workshop_day1_5_3">Workshop 3 : Contemplative
                              education: Learn Unlearn and Relearn
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance[2]; ?>
                                ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_5_4"
                              name="workshop_day1_5" value="w4">
                            <label class="custom-control-label" for="workshop_day1_5_4">Workshop 4 : Development and
                              Implementation-Game design-Board game
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance[3]; ?>
                                ที่</span></label>
                          </div>
                        </div>
                        <!-- Day 2 -->
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 1 พฤษภาคม พ.ศ. 2563 (14.45 - 16.00 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_5_1"
                              name="workshop_day2_5" value="w5">
                            <label class="custom-control-label" for="workshop_day2_5_1">Workshop 5 : เนรมิตห้องเรียน 4.0
                              ด้วยเครื่องมือดิจิทัล
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[0]; ?>
                                ที่</span></label>
                          </div>
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_5_2"
                              name="workshop_day2_5" value="w6">
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_5_3"
                              name="workshop_day2_5" value="w7">
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_5_4"
                              name="workshop_day2_5" value="w8">
                    ...
                    <div class="form-row  mt-2">
                      <div class="form-group col-12 gray mt-2">
                        ...
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 30 เมษายน พ.ศ. 2563 (13.00 - 14.30 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_1" name="workshop_day1_6"
                              value="w1">
                          ...
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_2" name="workshop_day1_6"
                              value="w2">
                            <label class="custom-control-label" for="workshop_day1_2">Workshop 2 : Research to
                              Innovation
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance[1]; ?>
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_3" name="workshop_day1_6"
                              value="w3">
                            <label class="custom-control-label" for="workshop_day1_3">Workshop 3 : Contemplative
                              education: Learn Unlearn and Relearn
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance[2]; ?>
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day1_4" name="workshop_day1_6"
                              value="w4">
                            <label class="custom-control-label" for="workshop_day1_4">Workshop 4 : Development and
                              Implementation-Game design-Board game
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance[3]; ?>
                        ...
                        <div class="form-group ml-3">
                          <label>วันพฤหัสบดีที่ 1 พฤษภาคม พ.ศ. 2563 (14.45 - 16.00 น.)</label>
                          <div class="custom-control  custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_1" name="workshop_day2_6"
                              value="w5">
                            <label class="custom-control-label" for="workshop_day2_1">Workshop 5 : เนรมิตห้องเรียน 4.0
                              ด้วยเครื่องมือดิจิทัล
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[0]; ?>
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_2" name="workshop_day2_6"
                              value="w6">
                            <label class="custom-control-label" for="workshop_day2_2">Workshop 6 : Micro mastery:
                              ประสบการณ์การพัฒนาการเรียนรู้เพื่อสร้าง “ความเก่งทีละเล็กทีละน้อย
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[1]; ?>
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_3" name="workshop_day2_6"
                              value="w7">
                            <label class="custom-control-label" for="workshop_day2_3">Workshop 7 :
                              วิจัยจัดการเรียนการสอน
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[2]; ?>
                          ...
                          <div class="custom-control custom-radio">
                            <input type="radio" class="custom-control-input" id="workshop_day2_4" name="workshop_day2_6"
                              value="w8">
                            <label class="custom-control-label" for="workshop_day2_4">Workshop 8 :
                              สร้างห้องเรียนแห่งอนาคตด้วยเทคโนโลยี iPad และ Personalization of Learning
                              <span class="badge badge-warning">เหลือที่นั่งอีก <?php echo $workshop_balance_2[3]; ?>
